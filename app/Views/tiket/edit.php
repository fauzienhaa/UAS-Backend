...
<div class="container">
    <div class="row">
        <div class="col">
            <h1 class="mt-2 text-center">Edit Tiket</h1>
            ...
            <div class="card ">
                ...
                <form action="/tiket/update/<?= $tiket['id']; ?>" method="POST">
                    <?= csrf_field(); ?>
                    <input type="hidden" name="kode_kereta" value="<?= $tiket['kode_kereta']; ?>">
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            ...
                            id="id_kereta" name="id_kereta" autofocus value="<?= $tiket['id_kereta']; ?>">
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            ...
                            id="tujuan" name="tujuan" value="<?= $tiket['tujuan']; ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            id="waktu_tiba" name="waktu_tiba" value="<?= $tiket['waktu_tiba']; ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            id="jumlah_tiket" name="jumlah_tiket" value="<?= $tiket['jumlah_tiket']; ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            id="harga" name="harga" value="<?= $tiket['harga']; ?>">
                            <div class="invalid-feedback">
